...
const popularsales = {
  ...
  items: [
    ...
    },
    {
      ...
      img: psale3,
      price: "16999",
      color: "from-violet-200 to-indigo-600",
      border: "border-indigo-300",
      shadow: "shadow-md shadow-violet-300",
    },
  ],
};
  ...
  items: [
    {
      ...
      img: product1,
      price: "8999",
      color: "from-blue-200 to-[#192a4f]",
      border: "border-blue-300",
      shadow: "shadow-sm shadow-[#344466]",
    },
    {
      id: "0M0x2",
      ...
      shadow: "shadow-sm shadow-green-50",
    },
    {
      id: "0M0x3",
      title: "Nike Air Spizike",
      text: "MEN Running Shoes",
      rating: "4.9",
      btn: "Buy Now",
      img: product3,
    ...
    },
    {
      ...
      img: product4,
      price: "9999",
      color: "from-amber-200 to-amber-900",
    ...
    },
    {
      ...
      img: product5,
      price: "15999",
      color: "from-amber-200 to-gray-500",
      border: "border-gray-300",
      shadow: "shadow-sm shadow-[#3e5241]",
    },
    {
      id: "0M0x6",
      ...
      shadow: "shadow-sm shadow-cyan-100",
    },
    {
      id: "0M0x7",
      ...
      shadow: "shadow-sm shadow-yellow-100",
    },
    {
      id: "0M0x8",
    ...
    },
    {
      ...
      img: product9,
      price: "7999",
      color: "from-indigo-200 to-purple-700",
      border: "border-purple-300",
      shadow: "shadow-sm shadow-indigo-200",
    },
    {
      id: "0M0x10",
      ...
      img: product10,
      price: "8499",
      color: "from-lime-200 to-lime-500",
      border: "border-lime-300",
      shadow: "shadow-sm shadow-lime-50",
    },
    {
      id: "0M0x11",
      ...
      img: product11,
      price: "13999",
      color: "from-red-200 to-blue-500",
      border: "border-blue-100",
      shadow: "shadow-sm shadow-black",
    },
    {
      id: "0M0x12",
      title: "Nike Electic 2.0",
      text: "MEN Running Shoes",
      rating: "5+",
      btn: "Buy Now",
      img: product12,
      price: "15999",
      color: "from-blue-200 to-black",
      border: "border-slate-300",
      shadow: "shadow-sm shadow-blue-500",
    },
  ],
};
